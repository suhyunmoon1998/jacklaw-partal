...
export const QUESTIONNAIRE_SECTIONS_ZH: QuestionnaireSection[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "employer_address", label: "雇主的详细地址（街道地址）是什么？", type: "text", helpText: "如果不清楚，填写“我不知道”即可。" },
      { id: "employer_city_state", label: "您工作的城市和州是哪里？", type: "text" },
      { id: "supervisor_name", label: "您主要的主管或经理叫什么名字？", type: "text", helpText: "如果不清楚，填写“我不知道名字”即可。" },
      { id: "supervisor_phone", label: "这位主管的电话号码是什么？", type: "text", helpText: "如果不清楚，填写“我不知道”即可。", placeholder: "(310) 555-0000" },
      { id: "hr_contact", label: "您的人事（HR）联系人是谁？或者人事部门叫什么名称？", type: "text", helpText: "填写“公司没有人事部门”或“我不知道”都可以。" },
  ...
  },
  {
    ...
    title: "非法解雇",
    questions: [
      { id: "fired_or_forced", label: "您是被解雇或被迫辞职的吗？", type: "select", options: ["是", "不是", "我不确定"] },
