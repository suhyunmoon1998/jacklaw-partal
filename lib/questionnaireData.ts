...
export const QUESTIONNAIRE_SECTIONS: QuestionnaireSection[] = [
  ...
  },
  {
    ...
    title: 'Dates Worked',
    questions: [
      { id: 'start_date', label: 'Date You Started Working', type: 'date' },
      { id: 'start_date_unsure', label: "Not sure of the exact date you started?", type: 'yes_no' },
      { id: 'start_date_approx', label: 'Approximate Start Date', type: 'text', placeholder: 'e.g., "Spring 2022" or "around March 2022"', showIf: { questionId: 'start_date_unsure', value: 'yes' } },
      { id: 'still_employed', label: 'Are you still employed there?', type: 'yes_no', required: true },
      { id: 'end_date', label: 'Last Day Working', type: 'date', showIf: { questionId: 'still_employed', value: 'no' } },
      { id: 'end_date_unsure', label: 'Not sure of the exact last day?', type: 'yes_no', showIf: { questionId: 'still_employed', value: 'no' } },
      { id: 'end_date_approx', label: 'Approximate Last Day Working', type: 'text', placeholder: 'e.g., "late 2023" or "around November 2023"', showIf: { questionId: 'end_date_unsure', value: 'yes' } },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'hourly_rate', label: 'Hourly Rate (if applicable)', type: 'currency', placeholder: '18.00' },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'believe_wrongful', label: 'Do you believe you were wrongfully or unlawfully terminated?', type: 'yes_no_unsure' },
      ...
      { id: 'wrongful_not_sure_details', label: 'What makes you unsure? Please share any details that might help us evaluate this.', type: 'textarea', showIf: { questionId: 'believe_wrongful', value: 'not_sure' } },
  ...
  },
  {
    ...
    questions: [
      { id: 'involves_disability', label: 'Does your situation involve a disability, medical condition, medical leave, or pregnancy?', type: 'yes_no', required: true },
      { id: 'took_medical_leave', label: 'Did you take medical or disability leave at any point?', type: 'yes_no', showIf: { questionId: 'involves_disability', value: 'yes' } },
      ...
      { id: 'requested_accommodation', label: 'Did you request a disability-related work accommodation?', type: 'yes_no', showIf: { questionId: 'involves_disability', value: 'yes' } },
      ...
      { id: 'was_pregnant', label: 'Were you pregnant during your employment?', type: 'yes_no', showIf: { questionId: 'involves_disability', value: 'yes' } },
