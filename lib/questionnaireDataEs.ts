...
export const QUESTIONNAIRE_SECTIONS_ES: QuestionnaireSection[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "entered_own_start", label: "¿Anotaba usted su propia hora de entrada la mayoría de los días de trabajo?", type: "select", options: ["Sí", "No", "A veces", "No se llevaba registro de la hora de entrada", "No sé"] },
      ...
      { id: "entered_own_end", label: "¿Anotaba usted su propia hora de salida la mayoría de los días de trabajo?", type: "select", options: ["Sí", "No", "A veces", "No se llevaba registro de la hora de salida", "No sé"] },
