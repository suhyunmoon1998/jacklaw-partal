...
export const QUESTIONNAIRE_SECTIONS_ES: QuestionnaireSection[] = [
  ...
  },
  {
    ...
    questions: [
      { id: 'start_date', label: 'Fecha en que Comenzó a Trabajar', type: 'date' },
      { id: 'start_date_unsure', label: '¿No está seguro de la fecha exacta en que comenzó?', type: 'yes_no' },
      { id: 'start_date_approx', label: 'Fecha Aproximada de Inicio', type: 'text', placeholder: 'Ej: "primavera de 2022" o "alrededor de marzo de 2022"', showIf: { questionId: 'start_date_unsure', value: 'yes' } },
      { id: 'still_employed', label: '¿Sigue trabajando ahí?', type: 'yes_no', required: true },
      { id: 'end_date', label: 'Último Día de Trabajo', type: 'date', showIf: { questionId: 'still_employed', value: 'no' } },
      { id: 'end_date_unsure', label: '¿No está seguro de su último día exacto?', type: 'yes_no', showIf: { questionId: 'still_employed', value: 'no' } },
      { id: 'end_date_approx', label: 'Último Día de Trabajo Aproximado', type: 'text', placeholder: 'Ej: "finales de 2023" o "alrededor de noviembre de 2023"', showIf: { questionId: 'end_date_unsure', value: 'yes' } },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'hourly_rate', label: 'Tarifa por Hora (si aplica)', type: 'currency', placeholder: '18.00' },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'believe_wrongful', label: '¿Cree que fue despedido injusta o ilegalmente?', type: 'yes_no_unsure' },
      ...
      { id: 'wrongful_not_sure_details', label: '¿Qué le hace no estar seguro? Comparta cualquier detalle que pueda ayudarnos a evaluar esto.', type: 'textarea', showIf: { questionId: 'believe_wrongful', value: 'not_sure' } },
  ...
  },
  {
    ...
    questions: [
      { id: 'involves_disability', label: '¿Su situación involucra una discapacidad, condición médica, licencia médica o embarazo?', type: 'yes_no', required: true },
      { id: 'took_medical_leave', label: '¿Tomó licencia médica o por discapacidad en algún momento?', type: 'yes_no', showIf: { questionId: 'involves_disability', value: 'yes' } },
      ...
      { id: 'requested_accommodation', label: '¿Solicitó una adaptación laboral por discapacidad?', type: 'yes_no', showIf: { questionId: 'involves_disability', value: 'yes' } },
      ...
      { id: 'was_pregnant', label: '¿Estuvo embarazada durante su empleo?', type: 'yes_no', showIf: { questionId: 'involves_disability', value: 'yes' } },
