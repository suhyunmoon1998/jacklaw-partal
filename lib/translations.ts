export const en = {
  ...
  q_yes: 'Yes',
  q_no: 'No',
  m_not_sent: 'Not open yet',
  m_not_sent_sub: 'Our office has not sent you this questionnaire yet. You will get an email when it is ready for you.',
  nr_best: 'Best guess',
  nr_low: 'Lowest',
  nr_high: 'Highest',
  m2_title: 'Pay & Breaks',
  m2_sub: 'Meal breaks, rest breaks, unpaid time and overtime',
  m2_start: 'Start',
  m2_resume: 'Continue',
  m2_done: 'Completed',
...
export const es: typeof en = {
  ...
  q_yes: 'Sí',
  q_no: 'No',
  m_not_sent: 'Aún no está disponible',
  m_not_sent_sub: 'Nuestra oficina todavía no le ha enviado este cuestionario. Recibirá un correo cuando esté listo para usted.',
...
export const zh: typeof en = {
  ...
  q_no: '否',
  m_not_sent: '尚未开放',
  m_not_sent_sub: '我们办公室还没有把这份问卷发给您。准备好后我们会给您发邮件。',
  nr_best: '最接近的估计',
  nr_low: '最少',
  nr_high: '最多',
  m2_title: '工资与休息',
  m2_sub: '用餐休息、带薪短休、没有拿到工资的时间与加班',
  m2_start: '开始',
  m2_resume: '继续',
  m2_done: '已完成',
  // 步骤
...
export const ko: typeof en = {
  ...
  q_yes: '예',
  q_no: '아니요',
  m_not_sent: '아직 열리지 않았습니다',
  m_not_sent_sub: '저희 사무실에서 이 문진표를 아직 보내드리지 않았습니다. 준비되면 이메일로 알려드리겠습니다.',
  nr_best: '가장 근접한 추정',
  nr_low: '최소',
  nr_high: '최대',
  m2_title: '급여와 휴게',
  m2_sub: '식사휴게, 휴식휴게, 임금을 받지 못한 시간, 초과근무',
  m2_start: '시작하기',
  m2_resume: '이어하기',
  m2_done: '완료',
  // 단계
