...
export const QUESTIONNAIRE_SECTIONS_KO: QuestionnaireSection[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "schedule_chosen_by", label: "근무 요일과 근무 시간은 누가 정했습니까?", type: "multiselect", options: ["사업주 또는 사장", "매니저 또는 팀장", "사무실 직원 또는 일정 담당자", "앱 또는 시스템", "고객 또는 작업 현장", "한 사람 또는 한 가지 방법 이상", "기타", "모르겠습니다"], helpText: "해당되는 것을 모두 선택해 주십시오." },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "start_entered_by_other", label: "귀하가 직접 출근 시간을 입력하지 않은 경우에는 누가 입력했습니까?", type: "select", options: ["사장 또는 상사", "매니저 또는 조장(반장)", "동료", "사무실 직원 또는 급여 담당자", "시스템이 자동으로 입력했습니다", "근무 일정표의 시간이 그대로 사용되었습니다", "한 사람 이상 또는 여러 가지 방법", "아무도 입력하지 않았습니다", "\"모르겠습니다\""] },
